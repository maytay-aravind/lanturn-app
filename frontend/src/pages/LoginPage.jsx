    ...
    <div className="flex items-center justify-center min-h-[85vh]">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8 animate-fade-in">
          ...
          <img src="/logo-dark.jpeg" alt="LanTURN Logo" className="logo-dark mx-auto h-32 w-auto object-contain mix-blend-screen keep-color" style={{ imageRendering: '-webkit-optimize-contrast', clipPath: 'inset(16%)', margin: '-14px 0' }} />
